...
constexpr int kTipcVirtioDeviceId = 13;

constexpr char kTipcMaxDevNameLen = 32;

constexpr uint8_t kTipcTxQueue = 0;
constexpr uint8_t kTipcRxQueue = 1;
constexpr uint8_t kTipcNumQueues = 2;
...
class TipcDevice : public VirtioDevice {
 public:
  ...
  machina::VirtioQueue* tx_queue() { return &queues_[kTipcTxQueue]; }
  machina::VirtioQueue* rx_queue() { return &queues_[kTipcRxQueue]; }
 ...
 private:
  ...
  machina::VirtioQueue queues_[kTipcNumQueues];
