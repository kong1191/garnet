...
// TODO(sy): please note only physically contiguous vmo can be used as shared
// memory Find a method to detect the given vmo is physically contiguous
...
using SharedMemPtr = fbl::RefPtr<SharedMem>;
