...
void TrustyApp::WaitOnService(std::string app_name, std::string service_name,
...
void TrustyApp::CancelWaitOnService(std::string app_name,
...
void TrustyApp::LookupService(std::string service_name,
...
void TrustyApp::AddService(std::string app_name, std::string service_name,
...
void TrustyApp::RemoveService(std::string service_name) {
  auto it = startup_services_.find(service_name);
  if (it != startup_services_.end()) {
...
void TrustyAppInstance::CancelWaitOnService(fidl::StringPtr service_name) {
  app_->CancelWaitOnService(app_name_, service_name);
}

void TrustyAppInstance::RemoveService(fidl::StringPtr service_name) {
