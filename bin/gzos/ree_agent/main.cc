...
class TaService : public AppmgrServices {
 public:
  TaService(zx::channel channel) { service_provider_.Bind(std::move(channel)); }
...
int main(int argc, const char** argv) {
  ...
  ree_agent::TaService ta_service_provider(std::move(appmgr_cli));
