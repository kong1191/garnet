...
class TipcChannelImpl
 ...
 public:
  ...
  bool is_ready() {
    fbl::AutoLock lock(&peer_ready_lock_);
    return peer_ready;
  }
 ...
 private:
  TipcChannelImpl() : binding_(this), peer_ready(false),
  ...
  fbl::Mutex peer_ready_lock_;
  bool peer_ready FXL_GUARDED_BY(peer_ready_lock_);
