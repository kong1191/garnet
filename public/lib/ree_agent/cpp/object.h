...
struct TipcObjectRef
  ...
  TipcObjectSet* parent;

  fbl::RefPtr<TipcObject> obj;

  using NodeState = fbl::DoublyLinkedListNodeState<TipcObjectRef*>;
...
class TipcObject : public fbl::RefCounted<TipcObject> {
 ...
 private:
  ...
  bool IsParentExists(TipcObjectSet* parent);
  ...
  using RefList = fbl::DoublyLinkedList<fbl::unique_ptr<TipcObjectRef>>;
